...
class GameRoundTest extends TestCase
{
    ...
    public function testCreateObject()
    {
        ...
        $this->assertInstanceOf("\Ylva\DiceGame\GameRound", $aGameRound);
    ...
    public function testCheckHand()
    {
        ...
        $this->assertInstanceOf("\Ylva\DiceGame\GameRound", $aGameRound2);
    ...
    public function testGetResult()
    {
        ...
        $this->assertInstanceOf("\Ylva\DiceGame\GameRound", $aGameRound3);
    ...
    public function testRegisterResults()
    {
        ...
        $this->assertInstanceOf("\Ylva\DiceGame\GameRound", $aGameRound4);
