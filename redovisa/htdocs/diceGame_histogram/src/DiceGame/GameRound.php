...
class GameRound
{
    ...
    */
    public function __construct($aPlayer, $nrOfDice)
    {
        ...
        # Create a dicehand that implements the DiceHandHisogram interface
        # So that visuals can be displayed of the throw
        $this->theDiceHand = new DiceHandHistogram($nrOfDice, $aPlayer);
   ...
   ** ***/
    ...
    * Get a histogram
    *
    * @return string    The histogram interface
    *
    *
    ** ***/
    public function getHistogram()
    {
      ...
      # Inject the diceHand data
      $histogram->injectData($this->theDiceHand);
