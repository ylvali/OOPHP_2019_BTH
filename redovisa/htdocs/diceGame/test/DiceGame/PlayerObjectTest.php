...
class PlayerObjectTest extends TestCase
{
    ...
    {
        $aPlayer = new Player();
        $this->assertInstanceOf("\Ylva\DiceGame\Player", $aPlayer);
    ...
    public function testNextPlayer()
    {
        $aPlayer2 = new Player();
        $aPlayer3 = new Player();
        $this->assertInstanceOf("\Ylva\DiceGame\Player", $aPlayer2);
        $this->assertInstanceOf("\Ylva\DiceGame\Player", $aPlayer3);
    ...
    {
        $aPlayer4 = new Player();
        $this->assertInstanceOf("\Ylva\DiceGame\Player", $aPlayer4);
    ...
    {
        $aPlayer5 = new Player();
        $this->assertInstanceOf("\Ylva\DiceGame\Player", $aPlayer5);
