...
/**
 *
 * Test cases for class TheGameObjectHistogram
 *
 */
class TheGameObjectHistogramTest extends TestCase
{
    /**
     *
    ...
    public function testCreateObject()
    {
        ...
        $this->assertInstanceOf("\Anax\DiceGame2\TheGameHistogram", $theGame);
    ...
    public function testSetFirstPlayer()
    {
        ...
        $this->assertInstanceOf("\Anax\DiceGame2\Player", $firstPlayer);
    }
    ...
    public function testPlayGame()
    {
        ...
        $theGame2 = new TheGameHistogram($nrDice, $playerArr2);
        $firstPlayer = $theGame->getFirstPlayer();
    ...
    public function testGetCurrentPlayerAndScore()
    {
        ...
        $this->assertInstanceOf("\Anax\DiceGame2\Player", $currentPlayer);
    ...
    public function testHistogramAndStatistics()
    {
        ...
        # Get histogram for a specific round
