...
class GameRoundTest extends TestCase
{
    ...
    public function testCreateObject()
    {
        ...
        $this->assertInstanceOf("\Anax\DiceGame2\GameRound", $aGameRound);
    ...
    public function testCheckHand()
    {
        ...
        $this->assertInstanceOf("\Anax\DiceGame2\GameRound", $aGameRound2);
    ...
    public function testGetResult()
    {
        ...
        $this->assertInstanceOf("\Anax\DiceGame2\GameRound", $aGameRound3);
    ...
    public function testRegisterResults()
    {
        ...
        $this->assertInstanceOf("\Anax\DiceGame2\GameRound", $aGameRound4);
