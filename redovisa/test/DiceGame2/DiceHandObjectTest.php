...
class DiceHandObjectTest extends TestCase
{
    ...
    public function testCreateObject()
    {
        $aPlayer = new Player();
        $nrDice = 5;
        $aDiceHand = new DiceHand($nrDice, $aPlayer);
        $this->assertInstanceOf("\Anax\DiceGame2\DiceHand", $aDiceHand);
    ...
    public function testThrowDice()
    {
        $aPlayer2 = new Player();
        $nrDice2 = 5;
        $aDiceHand2 = new DiceHand($nrDice2, $aPlayer2);
        $this->assertInstanceOf("\Anax\DiceGame2\DiceHand", $aDiceHand2);
