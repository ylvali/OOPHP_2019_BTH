...
class PlayerObjectTest extends TestCase
{
    ...
    {
        $aPlayer = new Player();
        $this->assertInstanceOf("\Anax\DiceGame2\Player", $aPlayer);
    ...
    public function testNextPlayer()
    {
        $aPlayer2 = new Player();
        $aPlayer3 = new Player();
        $this->assertInstanceOf("\Anax\DiceGame2\Player", $aPlayer2);
        $this->assertInstanceOf("\Anax\DiceGame2\Player", $aPlayer3);
    ...
    {
        $aPlayer4 = new Player();
        $this->assertInstanceOf("\Anax\DiceGame2\Player", $aPlayer4);
    ...
    {
        $aPlayer5 = new Player();
        $this->assertInstanceOf("\Anax\DiceGame2\Player", $aPlayer5);
