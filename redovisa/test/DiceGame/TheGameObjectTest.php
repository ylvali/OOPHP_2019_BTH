...
class TheGameObjectTest extends TestCase
{
    ...
    public function testCreateObject()
    {
        ...
        $this->assertInstanceOf("\Anax\DiceGame\TheGame", $theGame);
    ...
    public function testSetFirstPlayer()
    {
        ...
        $this->assertInstanceOf("\Anax\DiceGame\Player", $firstPlayer);
    }
    ...
    public function testGetCurrentPlayerAndScore()
    {
        ...
        $this->assertInstanceOf("\Anax\DiceGame\Player", $currentPlayer);
