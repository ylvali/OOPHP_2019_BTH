...
class DbBaseTestException extends TestCase
{
     ...
     *
     * @expectedException \Anax\ProductDb\DbBaseException
     *
    ...
    public function testExpectedExceptionIsRaised()
    {
        ...
        $anaxObj = 'testError';
        $test = null;
        $dbBase2 = new DbBase($host, $theDb, $user, $password, $test, $anaxOn, $anaxObj);
        $this->assertInstanceOf("\Anax\ProductDb\DbBase", $dbBase2);
        $res4 = $dbBase->getData($sql3);
        //var_dump($res3);
